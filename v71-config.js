...
const config=Object.freeze({
 version:'8.1.0',stableBase:'8.0.0',canonicalHost:'https://otaviobarretojr.github.io/pre-venda-samsung/',fallbackHost:'https://pre-venda-samsung.pages.dev/',
...
window.PRE_SALE_V71=config;window.PRE_SALE_V72=config;window.PRE_SALE_V73=config;window.PRE_SALE_V74=config;window.PRE_SALE_V741=config;window.PRE_SALE_V80=config;window.PRE_SALE_V81=config;window.dispatchEvent(new CustomEvent('pre-sale:v71-config',{detail:config}));
})();