...
const professional=document.createElement('script');professional.src='./professional-v640.js?v=6.4.2';professional.onload=()=>{const hardening=document.createElement('script');hardening.src='./professional-v641-hardening.js?v=6.4.2';hardening.onload=()=>{const finalization=document.createElement('script');finalization.src='./professional-v642-finalization.js?v=6.4.2';finalization.onload=()=>{const offers=document.createElement('script');offers.src='./ecosystem-offers-v657.js?v=6.5.8';offers.onload=()=>{const enterprise=document.createElement('script');enterprise.src='./enterprise-v650.js?v=6.5.8';document.body.appendChild(enterprise)};document.body.appendChild(offers)};document.body.appendChild(finalization)};document.body.appendChild(hardening)};document.body.appendChild(professional);
})();
