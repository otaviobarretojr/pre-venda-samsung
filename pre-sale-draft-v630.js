...
const V='7.0.1';
const budgetBrand=document.createElement('script');budgetBrand.src='./budget-brand-20260820.js?v='+V;budgetBrand.onload=bootProfessional;budgetBrand.onerror=bootProfessional;document.body.appendChild(budgetBrand);
function bootProfessional(){const professional=document.createElement('script');professional.src='./professional-v640.js?v='+V;professional.onload=()=>{const hardening=document.createElement('script');hardening.src='./professional-v641-hardening.js?v='+V;hardening.onload=()=>{const finalization=document.createElement('script');finalization.src='./professional-v642-finalization.js?v='+V;finalization.onload=()=>{const offers=document.createElement('script');offers.src='./ecosystem-offers-v657.js?v='+V;offers.onload=()=>{const print=document.createElement('script');print.src='./ecosystem-print-v700.js?v='+V;print.onload=()=>{const enterprise=document.createElement('script');enterprise.src='./enterprise-v650.js?v='+V;enterprise.onload=()=>{const release=document.createElement('script');release.src='./v7-release.js?v='+V;release.onload=()=>window.preSaleReleaseBoot?.();release.onerror=()=>window.preSaleReleaseBoot?.();document.body.appendChild(release)};enterprise.onerror=()=>window.preSaleReleaseBoot?.();document.body.appendChild(enterprise)};print.onerror=()=>{const enterprise=document.createElement('script');enterprise.src='./enterprise-v650.js?v='+V;enterprise.onload=()=>{const release=document.createElement('script');release.src='./v7-release.js?v='+V;release.onload=()=>window.preSaleReleaseBoot?.();release.onerror=()=>window.preSaleReleaseBoot?.();document.body.appendChild(release)};enterprise.onerror=()=>window.preSaleReleaseBoot?.();document.body.appendChild(enterprise)};document.body.appendChild(print)};document.body.appendChild(offers)};document.body.appendChild(finalization)};document.body.appendChild(hardening)};document.body.appendChild(professional)}
setTimeout(()=>window.preSaleReleaseBoot?.(),12000);
})();