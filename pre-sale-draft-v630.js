...
const professional=document.createElement('script');professional.src='./professional-v640.js?v=6.5.9';professional.onload=()=>{const hardening=document.createElement('script');hardening.src='./professional-v641-hardening.js?v=6.5.9';hardening.onload=()=>{const finalization=document.createElement('script');finalization.src='./professional-v642-finalization.js?v=6.5.9';finalization.onload=()=>{const offers=document.createElement('script');offers.src='./ecosystem-offers-v657.js?v=6.5.9';offers.onload=()=>{const enterprise=document.createElement('script');enterprise.src='./enterprise-v650.js?v=6.5.9';enterprise.onload=()=>{document.querySelector('.footer-note')&&(document.querySelector('.footer-note').textContent='PRE VENDA • v6.5.9 ONLINE');requestAnimationFrame(()=>requestAnimationFrame(()=>window.preSaleReleaseBoot?.()))};enterprise.onerror=()=>window.preSaleReleaseBoot?.();document.body.appendChild(enterprise)};document.body.appendChild(offers)};document.body.appendChild(finalization)};document.body.appendChild(hardening)};document.body.appendChild(professional);
// Fail-safe: nunca deixa o aplicativo preso na tela de inicialização em conexão ruim.
