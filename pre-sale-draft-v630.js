...
const professional=document.createElement('script');professional.src='./professional-v640.js?v=6.4.1';professional.onload=()=>{const hardening=document.createElement('script');hardening.src='./professional-v641-hardening.js?v=6.4.1';document.body.appendChild(hardening)};document.body.appendChild(professional);
})();