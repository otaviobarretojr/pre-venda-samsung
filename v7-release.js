...
'use strict';
const RELEASE='7.0.1';
const CACHE_EPOCH='v7-0-1-brand-budget';
...
const loadValidation=async()=>{if(window.__V7_VALIDATION_LOADED__)return;window.__V7_VALIDATION_LOADED__=true;try{await loadScript('./pre-sale-watches-v7.js?release='+encodeURIComponent(RELEASE),'watches');await loadScript('./v7-smoke-test.js?release='+encodeURIComponent(RELEASE),'smoke')}catch(e){document.documentElement.dataset.v7Smoke='load-error';console.error('[V7] validation module failed to load',e)}};
