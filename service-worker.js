const CACHE_NAME = "pre-venda-samsung-v4-3-3";
const APP_SHELL = [
  "./",
  "./index.html",
...
async function injectAdminLock(response){
  ...
  let injected=text;
  if(!injected.includes('admin-lock.js?v=4.3.3')){
    injected=injected.replace('</body>','<script src="./admin-lock.js?v=4.3.3"></script></body>');
  }
