const CACHE_NAME = 'pre-venda-samsung-v7-0-0-stable-1';
const APP_SHELL = [
  './','./index.html','./ecosystem-v454.js','./v5.js','./v5.css','./v51.js','./v51.css','./bulk-import.js','./history-multiselect.js','./admin-safety.js','./dashboard-v515.js','./dashboard-ranking-filter.js','./dashboard-calc-fix.js','./save-guard.js','./stability-v520.js','./dashboard-clean-v520.js','./professional-v540.js','./management-v560.js','./budget-v570.js','./budget-history-v600.js','./catalog-am-2025-2026.js','./pre-sale-draft-v630.js','./professional-v640.js','./professional-v641-hardening.js','./professional-v642-finalization.js','./enterprise-v650.js','./ecosystem-offers-v657.js','./ecosystem-print-v700.js','./v7-release.js','./pre-sale-watches-v7.js','./v7-smoke-test.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'
];
