...
.dash-revenue-panel{margin-top:14px}.dash-revenue-row{display:grid;grid-template-columns:minmax(140px,1fr) minmax(100px,1.5fr) 110px;gap:12px;align-items:center;padding:9px 0;font-size:12px}.dash-revenue-row>span{font-weight:700}.dash-revenue-row>i{height:7px;background:#edf0f5;border-radius:999px;overflow:hidden}.dash-revenue-row>i b{display:block;height:100%;background:linear-gradient(90deg,#1428A0,#3156d3);border-radius:999px}.dash-revenue-row>strong{text-align:right;color:#1428A0}
