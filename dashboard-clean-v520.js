...
.dash-product-accordion{margin-bottom:10px;padding:0 14px;background:#fbfcff;border-radius:14px;box-shadow:0 1px 4px rgba(16,24,40,.06)}.dash-product-accordion:last-child{margin-bottom:0}.dash-product-expand{width:100%;display:grid;grid-template-columns:28px minmax(170px,1.4fr) minmax(100px,1.7fr) 40px 22px;gap:12px;align-items:center;padding:14px 0;background:transparent;color:#101828;text-align:left}.dash-product-name{font-weight:800;font-size:13px}.dash-product-name small{display:block;margin-top:4px;color:#98a2b3;font-size:10px;font-weight:500}.dash-product-expand>strong{text-align:right;font-size:14px}.dash-product-chevron{width:22px;height:22px;display:grid;place-items:center;border-radius:7px;background:#eef2ff;font-size:17px;color:#1428A0;transition:transform .15s}.dash-product-expand[aria-expanded="true"] .dash-product-chevron{transform:rotate(180deg)}.dash-product-breakdown{display:grid;grid-template-columns:1fr 1fr;gap:24px;margin:0 0 14px;padding:15px 16px;background:#f2f5fa;border-radius:12px}.dash-product-breakdown h4{margin:0 0 10px;font-size:11px;text-transform:uppercase;letter-spacing:.35px;color:#475467}.dash-product-mini{display:grid;grid-template-columns:minmax(90px,1fr) minmax(60px,1.2fr) 28px;gap:9px;align-items:center;padding:6px 0;font-size:11px}.dash-product-mini>i{height:5px;background:#dfe5ed;border-radius:999px;overflow:hidden}.dash-product-mini>i b{display:block;height:100%;background:linear-gradient(90deg,#1428A0,#3156d3);border-radius:999px}.dash-product-mini>strong{text-align:right}.dash-product-accordion .dash-clean-track{height:6px;background:#e8edf4}.dash-product-accordion .dash-clean-track i{background:linear-gradient(90deg,#1428A0,#3156d3)}
...
const f=document.querySelector('.footer-note');if(f)f.textContent='PRE VENDA • v5.2.4 ONLINE';
})();
