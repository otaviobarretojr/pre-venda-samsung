...
function buildShell(){
 ...
 header.innerHTML=`<div class="ent-head-left"><button type="button" id="enterpriseMenuToggle" aria-label="Abrir menu">☰</button><div><small>OPERAÇÃO SAMSUNG MANAUARA</small><h1 id="enterprisePageTitle">${pageTitle(currentPanel())}</h1></div></div><div class="ent-head-actions"><div id="enterpriseSyncState" class="ent-sync"></div><button type="button" id="enterpriseSyncButton" class="ent-icon-button" title="Sincronizar">↻</button><button type="button" id="enterpriseNewButton" class="btn">＋ Nova pré-venda</button></div>`;
 ...
 $('enterpriseNewButton').onclick=()=>typeof startNewSale==='function'?startNewSale():switchTab('formPanel');
...
function renderCockpit(){
 ...
 const revenue=todayRows.reduce((sum,row)=>sum+Number(window.getPreSaleFinalValue?.(row)||row.valorFinal||row.valor||0),0);
...
body.enterprise-mode .content{max-width:1500px;margin:0 auto}body.enterprise-mode .quick-info{display:none!important}body.enterprise-mode .card{border:1px solid var(--ent-line);border-radius:16px;box-shadow:0 5px 20px rgba(29,45,91,.05);padding:22px}body.enterprise-mode input,body.enterprise-mode select,body.enterprise-mode textarea{border-color:#d7deea;border-radius:10px;min-height:43px}body.enterprise-mode label{color:#3b465d;font-size:11px;letter-spacing:.25px}body.enterprise-mode .btn{background:var(--ent-blue);border-radius:10px;box-shadow:none}body.enterprise-mode .btn:hover{background:var(--ent-blue2)}
.ent-cockpit{display:grid;gap:16px;margin-bottom:16px}.ent-welcome{display:flex;align-items:center;justify-content:space-between;padding:25px;border-radius:17px;color:#fff;background:linear-gradient(125deg,#1428a0,#2945c7);box-shadow:0 14px 34px rgba(20,40,160,.2)}.ent-welcome span,.ent-block-title small,.ent-section-head small{font-size:9px;letter-spacing:1.2px;font-weight:900}.ent-welcome h2{font-size:25px;margin:5px 0}.ent-welcome p{margin:0;color:#dbe1ff}.ent-welcome .btn{background:#fff;color:var(--ent-blue)}
.ent-kpis{display:grid;grid-template-columns:repeat(4,1fr);gap:12px}.ent-kpis button{min-width:0;padding:17px;border:1px solid var(--ent-line);border-radius:14px;background:#fff;text-align:left;box-shadow:0 4px 15px rgba(29,45,91,.04);cursor:pointer}.ent-kpis button:hover{transform:translateY(-1px);border-color:#bcc7e4}.ent-kpis small,.ent-kpis strong,.ent-kpis span{display:block}.ent-kpis small{font-size:9px;color:#69758c;font-weight:900;letter-spacing:.65px}.ent-kpis strong{font-size:27px;margin:8px 0;color:#1428a0}.ent-kpis span{font-size:10px;color:#8b96aa}.ent-kpis .revenue{grid-column:span 4;background:#101f72;color:#fff}.ent-kpis .revenue strong,.ent-kpis .revenue small,.ent-kpis .revenue span{color:#fff}
